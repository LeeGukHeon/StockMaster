...
from app.intraday.strategy import evaluate_intraday_strategy_comparison
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate intraday strategy comparison.")
...
def main() -> int:
    ...
    result = evaluate_intraday_strategy_comparison(
        settings,
    ...
    logger.info("Intraday strategy comparison completed.", extra={"run_id_value": result.run_id})
    print(
        f"Intraday strategy comparison completed. range={args.start_session_date.isoformat()}.."
