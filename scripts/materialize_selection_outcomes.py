...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Freeze selection-time snapshots vs realized outcomes."
    )
    parser.add_argument("--selection-date", type=_parse_date)
    parser.add_argument("--start-selection-date", type=_parse_date)
    parser.add_argument("--end-selection-date", type=_parse_date)
...
def main() -> int:
    ...
    print(
        f"Selection outcomes completed. run_id={result.run_id} rows={result.row_count} "
