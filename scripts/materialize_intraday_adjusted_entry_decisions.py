...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Materialize adjusted intraday entry decisions.")
...
def main() -> int:
    ...
    result = materialize_intraday_adjusted_entry_decisions(
        settings,
    ...
    logger.info(
        "Adjusted intraday entry decisions completed.",
