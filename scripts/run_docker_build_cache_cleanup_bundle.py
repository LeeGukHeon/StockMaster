...
from app.ops.bundles import run_docker_build_cache_cleanup_bundle
from scripts._ops_cli import load_cli_settings, log_and_print, parse_date


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Docker build cache cleanup bundle.")
    ...
    log_and_print(
        "Docker build cache cleanup bundle completed. "
