...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Sync curated investor flow rows from KIS.")
    parser.add_argument("--trading-date", required=True, type=_parse_date)
...
def main() -> int:
    ...
    logger.info(
        ...
        extra={
            ...
            "trading_date": args.trading_date.isoformat(),
            "row_count": result.row_count,
        },
    )
    print(
        f"Investor flow sync completed. trading_date={args.trading_date.isoformat()} "
