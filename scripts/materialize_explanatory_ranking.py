...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build explanatory ranking v0.")
...
def main() -> int:
    ...
    print(
        f"Explanatory ranking completed. as_of_date={args.as_of_date.isoformat()} "
