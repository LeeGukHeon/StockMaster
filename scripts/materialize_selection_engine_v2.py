...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Materialize selection engine v2.")
...
def main() -> int:
    ...
    result = materialize_selection_engine_v2(
        settings,
    ...
    logger.info(
        "Selection engine v2 completed.",
        extra={"run_id_value": result.run_id, "row_count": result.row_count},
    )
    print(
        f"Selection engine v2 completed. as_of_date={args.as_of_date.isoformat()} "
