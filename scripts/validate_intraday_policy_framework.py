...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate intraday policy framework.")
...
def main() -> int:
    ...
    result = validate_intraday_policy_framework(
        settings,
        as_of_date=args.as_of_date,
        horizons=args.horizons,
    )
    logger.info(
        "Intraday policy framework validation completed.", extra={"run_id_value": result.run_id}
    )
    print(
        "Intraday policy framework validation completed. "
