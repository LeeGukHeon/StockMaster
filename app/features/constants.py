...
FEATURE_SPECS: tuple[FeatureSpec, ...] = (
    ...
    FeatureSpec("residual_ret_3d", "price_trend"),
    FeatureSpec("residual_ret_5d", "price_trend"),
    FeatureSpec("residual_ret_10d", "price_trend"),
    ...
    FeatureSpec("turnover_burst_persistence_5d", "liquidity_turnover"),
    ...
    FeatureSpec("news_burst_share_1d", "news_catalyst"),
    FeatureSpec("news_drift_persistence_score", "news_catalyst"),
    ...
    FeatureSpec("foreign_flow_persistence_5d", "investor_flow"),
    FeatureSpec("institution_flow_persistence_5d", "investor_flow"),
    FeatureSpec("flow_disagreement_score", "investor_flow"),
