...
SCHEDULED_JOBS: tuple[ScheduledJobDefinition, ...] = (
    ...
    ScheduledJobDefinition(
        ...
        label="장후 추천 생성",
        description=(
            "v4 종가RR 3~5D 하이브리드 추천, entry_policy, portfolio, "
    ...
    ScheduledJobDefinition(
        ...
        bundle_args=(),
        schedule_label="화-토 05:30",
        on_calendar=("Tue..Sat *-*-* 05:30:00",),
        weekdays=(1, 2, 3, 4, 5),
        run_times=("05:30",),
        date_semantics=DATE_SEMANTICS_CALENDAR,
    ),
    ScheduledJobDefinition(
        ...
        bundle_args=(),
        schedule_label="Weekdays 21:30",
        on_calendar=("Mon..Fri *-*-* 21:30:00",),
        weekdays=(0, 1, 2, 3, 4),
        run_times=("21:30",),
        date_semantics=DATE_SEMANTICS_TRADING,
        trading_day_required=True,
    ...
    ScheduledJobDefinition(
        ...
        bundle_args=(),
        schedule_label="매일 04:30",
        on_calendar=("*-*-* 04:30:00",),
        weekdays=(0, 1, 2, 3, 4, 5, 6),
        run_times=("04:30",),
        date_semantics=DATE_SEMANTICS_CALENDAR,
    ),
    ...
    ScheduledJobDefinition(
        ...
        bundle_args=(),
        schedule_label="토요일 10:00",
        on_calendar=("Sat *-*-* 10:00:00",),
        weekdays=(5,),
        run_times=("10:00",),
        date_semantics=DATE_SEMANTICS_HYBRID,
    ),
    ScheduledJobDefinition(
        ...
        bundle_args=(),
        schedule_label="Sat 14:00",
        on_calendar=("Sat *-*-* 14:00:00",),
        weekdays=(5,),
        run_times=("14:00",),
        date_semantics=DATE_SEMANTICS_HYBRID,
        heavy_job=True,
