    ...
    *,
    ...
    return connection.execute(
        ...
        SELECT
            ...
            label.min_forward_return,
            label.take_profit_3_hit,
            label.take_profit_3_date,
            label.take_profit_5_hit,
            label.take_profit_5_date,
            label.stop_loss_3_hit,
            label.stop_loss_3_date,
            label.stop_loss_5_hit,
            label.stop_loss_5_date,
