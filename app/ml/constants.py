...
# Daily close trains/evaluates the cash-path D5 candidate when active_d5_swing is enabled.
# Keep the spec itself experimental so ad-hoc/default training does not expand unexpectedly.
D5_DAILY_H5_CANDIDATE_MODEL_SPEC_ID = D5_PRACTICAL_V3_MODEL_SPEC_ID
...
CHALLENGER_ALPHA_MODEL_SPECS: tuple[AlphaModelSpec, ...] = (
    ...
    AlphaModelSpec(
        ...
        training_target_variant="practical_excess_return_v2",
        validation_primary_metric_name="top5_mean_excess_return",
        promotion_primary_loss_name="loss_top5",
        allowed_horizons=(5,),
    ),
    ...
    AlphaModelSpec(
        ...
        training_target_variant="stable_practical_excess_return",
        validation_primary_metric_name="top5_mean_excess_return",
        promotion_primary_loss_name="loss_top5",
        allowed_horizons=(5,),
    ),
    AlphaModelSpec(
        ...
        training_target_variant="robust_buyable_excess_return",
        validation_primary_metric_name="top5_mean_excess_return",
        promotion_primary_loss_name="loss_top5",
        allowed_horizons=(5,),
    ),
...
def resolve_target_column_for_spec(model_spec: AlphaModelSpec, *, horizon: int) -> str:
    ...
    if target_variant == "robust_buyable_excess_return":
        return f"target_robust_buyable_excess_h{int(horizon)}"
